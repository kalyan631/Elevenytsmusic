...
class Config:
    ...
    def __init__(self):
        ...
        self.SUPPORT_CHANNEL: str = getenv(
            "SUPPORT_CHANNEL", "https://t.me/+lTEBxEi-435hMGM1")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "https://t.me/+rTXlUr25H1YwOThl")
        ...
        self.DEFAULT_THUMB: str = getenv(
            "DEFAULT_THUMB",
            "https://files.catbox.moe/iv2w0d.jpg"  # Default thumbnail
        )
        self.PING_IMG: str = getenv(
            "PING_IMG", "https://files.catbox.moe/iv2w0d.jpg")    # Ping command image
        self.START_IMG: str = getenv(
            "START_IMG", "https://files.catbox.moe/iv2w0d.jpg")  # Start command image
        self.RADIO_IMG: str = getenv(
            "RADIO_IMG", "https://files.catbox.moe/iv2w0d.jpg")    # Radio command image
